 ...
 * @since 0.2.0.0
 */
public class SpongeItemNameComponent extends ItemNameComponent<SpongeItemStack, ItemStack> {

  public SpongeItemNameComponent() {

  }

  public SpongeItemNameComponent(final Component itemName) {
