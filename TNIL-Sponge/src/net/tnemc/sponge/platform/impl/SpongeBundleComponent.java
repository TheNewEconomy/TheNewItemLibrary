 ...
 * @since 0.2.0.0
 */
public class SpongeBundleComponent extends BundleComponent<SpongeItemStack, ItemStack> {

  public SpongeBundleComponent() {

  }

  public SpongeBundleComponent(final Map<Integer, AbstractItemStack<ItemStack>> items) {
  ...
  public boolean appliesTo(final ItemStack item) {
    ...
    //11.0.0 for inventory
    //13.0.0 for is ItemTypeTags.BUNDLES
    return item.supports(Key.from(ResourceKey.sponge("inventory"), Inventory.class)) && item.type().is(ItemTypeTags.BUNDLES);
  }
