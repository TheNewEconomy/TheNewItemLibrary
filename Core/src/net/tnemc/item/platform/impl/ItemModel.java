 ...
 * @since 0.1.7.7
 */
public abstract class ItemModel<I extends AbstractItemStack<T>, T> implements ItemCheck<T>, ItemApplicator<I, T>, ItemSerializer<I, T> {
  ...
  public boolean check(final AbstractItemStack<T> original, final AbstractItemStack<T> check) {
    ...
    return original.model().equalsIgnoreCase(check.model());
  }
}