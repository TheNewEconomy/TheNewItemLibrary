 ...
 * @since 0.2.0.0
 */
public abstract class ItemResistence<I extends AbstractItemStack<T>, T> implements ItemCheck<T>, ItemApplicator<I, T>, ItemSerializer<I, T> {
  ...
  public boolean check(final AbstractItemStack<T> original, final AbstractItemStack<T> check) {
    ...
    return original.resistence().equals(check.resistence());
  }
}