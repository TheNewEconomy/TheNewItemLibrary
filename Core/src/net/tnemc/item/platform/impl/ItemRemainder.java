 ...
 * @since 0.2.0.0
 */
public abstract class ItemRemainder<I extends AbstractItemStack<T>, T> implements ItemCheck<T>, ItemApplicator<I, T>, ItemSerializer<I, T> {
  ...
  public boolean check(final AbstractItemStack<T> original, final AbstractItemStack<T> check) {
    ...
    //TODO: Refine this
    return original.remainder().equals(check.remainder());
  }
}