 ...
 * @since 0.1.7.7
 */
public abstract class ItemSerialData<I extends AbstractItemStack<T>, T> implements ItemCheck<T>, ItemApplicator<I, T>, ItemSerializer<I, T> {
