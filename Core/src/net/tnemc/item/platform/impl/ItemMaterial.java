 ...
 * @since 0.1.7.7
 */
public abstract class ItemMaterial<I extends AbstractItemStack<T>, T> implements ItemCheck<T>, ItemApplicator<I, T>, ItemDeserializer<I, T> {
  ...
  public boolean check(AbstractItemStack<T> original, AbstractItemStack<T> check) {
    return original.material().equalsIgnoreCase(check.material());
  }
}