 ...
 * @since 0.2.0.0
 */
public class PersistentDouble extends PersistentDataType<Double> {

  public PersistentDouble(final String namespace, final String key) {
   ...
   */
  @Override
  public Double decode(final String encoded) throws IllegalArgumentException {
