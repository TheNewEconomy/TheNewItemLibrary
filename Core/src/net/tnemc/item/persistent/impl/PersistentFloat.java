 ...
 * @since 0.2.0.0
 */
public class PersistentFloat extends PersistentDataType<Float> {

  public PersistentFloat(final String namespace, final String key) {
   ...
   */
  @Override
  public Float decode(final String encoded) throws IllegalArgumentException {
