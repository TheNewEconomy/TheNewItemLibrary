 ...
 * @since 0.2.0.0
 */
public class PersistentString extends PersistentDataType<String> {

  public PersistentString(final String namespace, final String key) {
   ...
   */
  @Override
  public String decode(final String encoded) throws IllegalArgumentException {
