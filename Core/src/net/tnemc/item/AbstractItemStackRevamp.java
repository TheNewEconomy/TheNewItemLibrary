 ...
 */
public interface AbstractItemStackRevamp<T> extends Cloneable {
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> of(final String material, final int amount);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> of(T locale);
   ...
   */
  AbstractItemStackRevamp<T> of(JSONObject json) throws ParseException;
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> flags(List<String> flags);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> loreComponent(List<Component> lore);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> enchant(String enchantment, int level);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> enchant(Map<String, Integer> enchantments);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> enchant(List<String> enchantments);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> material(String material);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> amount(final int amount);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> slot(int slot);
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> debug(boolean debug);
   ...
   * @author creatorfromhell
   */
  default AbstractItemStackRevamp<T> applyComponent(final SerialComponent<AbstractItemStack<T>, T> component) {
   ...
   * @author creatorfromhell
   */
  default AbstractItemStackRevamp<T> applyPersistent(final PersistentDataType<?> data) {
   ...
   * @author creatorfromhell
   */
  AbstractItemStackRevamp<T> applyPersistentHolder(final PersistentDataHolder newHolder, boolean replaceOld);
   ...
   * @see AttributeModifiersComponent
   */
  AbstractItemStackRevamp<T> attributeModifiers(List<AttributeModifier> modifiers, boolean showInTooltip);
   ...
   * @see BannerPatternsComponent
   */
  AbstractItemStackRevamp<T> bannerPatterns(List<PatternData> patterns);
   ...
   * @see BaseColorComponent
   */
  AbstractItemStackRevamp<T> baseColor(String color);
   ...
   * @see CanBreakComponent
   */
  AbstractItemStackRevamp<T> canBreak(List<BlockPredicate> predicates);
   ...
   * @see CanPlaceOnComponent
   */
  AbstractItemStackRevamp<T> canPlaceOn(List<BlockPredicate> predicates);
   ...
   * @see CustomNameComponent
   */
  AbstractItemStackRevamp<T> customName(String customName);
   ...
   * @see DamageComponent
   */
  AbstractItemStackRevamp<T> damage(int damage);
   ...
   * @see DamageResistantComponent
   */
  AbstractItemStackRevamp<T> damageResistant(List<String> types);
   ...
   * @see DeathProtectionComponent
   */
  AbstractItemStackRevamp<T> deathProtection(List<ComponentEffect> deathEffects);
   ...
   * @see DyedColorComponent
   */
  AbstractItemStackRevamp<T> dyedColor(int rgb);
   ...
   * @see EnchantableComponent
   */
  AbstractItemStackRevamp<T> enchantable(int value);
   ...
   * @see EnchantmentGlintOverrideComponent
   */
  AbstractItemStackRevamp<T> enchantmentGlintOverride(boolean glintOverride);
   ...
   * @see EnchantmentsComponent
   */
  AbstractItemStackRevamp<T> enchantments(Map<String, Integer> levels);
   ...
   * @see FireworkExplosionComponent
   */
  AbstractItemStackRevamp<T> fireworkExplosion(ExplosionData explosion);
   ...
   * @see FireworksComponent
   */
  AbstractItemStackRevamp<T> fireworks(byte flightDuration, List<ExplosionData> explosions);
   ...
   * @see FoodComponent
   */
  AbstractItemStackRevamp<T> food(boolean noHunger, float saturation, int nutrition);
   ...
   * @see GliderComponent
   */
  AbstractItemStackRevamp<T> gliderTag();
   ...
   * @see HideAdditionalTooltipComponent
   */
  AbstractItemStackRevamp<T> hideAdditionalTooltipTag();
   ...
   * @see HideTooltipComponent
   */
  AbstractItemStackRevamp<T> hideTooltipTag();
   ...
   * @see InstrumentComponent
   */
  AbstractItemStackRevamp<T> instrument(String soundEvent, int useDuration, int range);
   ...
   * @see IntangibleProjectileComponent
   */
  AbstractItemStackRevamp<T> intangibleProjectileTag();
   ...
   * @see ItemModelComponent
   */
  AbstractItemStackRevamp<T> itemModel(String model);
   ...
   * @see ItemNameComponent
   */
  AbstractItemStackRevamp<T> itemName(String itemName);
   ...
   * @see JukeBoxComponent
   */
  AbstractItemStackRevamp<T> jukebox(String song, boolean showInTooltip);
   ...
   * @see LodestoneTrackerComponent
   */
  AbstractItemStackRevamp<T> lodestoneTracker(String target, int[] pos, String dimension, boolean tracked);
   ...
   * @see LoreComponent
   */
  AbstractItemStackRevamp<T> lore(List<String> lore);
   ...
   * @see MapColorComponent
   */
  AbstractItemStackRevamp<T> mapColor(int mapColor);
   ...
   * @see MapIDComponent
   */
  AbstractItemStackRevamp<T> mapId(int mapId);
   ...
   * @see MaxDamageComponent
   */
  AbstractItemStackRevamp<T> maxDamage(int maxDamage);
   ...
   * @see MaxStackSizeComponent
   */
  AbstractItemStackRevamp<T> maxStackSize(int maxStackSize);
   ...
   * @see ModelDataComponent
   */
  AbstractItemStackRevamp<T> modelData(List<String> colours, List<Float> floats, List<Boolean> flags, List<String> strings);
   ...
   * @see NoteBlockSoundComponent
   */
  AbstractItemStackRevamp<T> noteBlockSound(String soundId);
   ...
   * @see OminousBottleAmplifierComponent
   */
  AbstractItemStackRevamp<T> ominousBottleAmplifier(int amplifier);
   ...
   * @see PotDecorationsComponent
   */
  AbstractItemStackRevamp<T> potDecorations(List<String> decorations);
   ...
   * @see RarityComponent
   */
  AbstractItemStackRevamp<T> rarity(String rarity);
   ...
   * @see RecipesComponent
   */
  AbstractItemStackRevamp<T> recipes(List<String> recipes);
   ...
   * @see RepairableComponent
   */
  AbstractItemStackRevamp<T> repairable(List<String> repairItems);
   ...
   * @see RepairCostComponent
   */
  AbstractItemStackRevamp<T> repairCost(int repairCost);
   ...
   * @see StoredEnchantmentsComponent
   */
  AbstractItemStackRevamp<T> storedEnchantments(Map<String, Integer> enchantments);
   ...
   * @see SuspiciousStewEffectsComponent
   */
  AbstractItemStackRevamp<T> suspiciousStewEffects(String effectId, int duration);
   ...
   * @see TooltipStyleComponent
   */
  AbstractItemStackRevamp<T> tooltipStyle(String style);
   ...
   * @see TrimComponent
   */
  AbstractItemStackRevamp<T> trim(String pattern, String material, boolean showInTooltip);
   ...
   * @see UnbreakableComponent
   */
  AbstractItemStackRevamp<T> unbreakable(boolean showInTooltip);
   ...
   * @see WritableBookContentComponent
   */
  AbstractItemStackRevamp<T> writableBookContent(List<String> pages);
   ...
   * @see WrittenBookContentComponent
   */
  AbstractItemStackRevamp<T> writtenBookContent(String title, String author, int generation, boolean resolved, List<String> pages);
}
