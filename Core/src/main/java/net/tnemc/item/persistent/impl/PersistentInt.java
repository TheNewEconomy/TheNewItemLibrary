 ...
 * @since 0.2.0.0
 */
public class PersistentInt extends PersistentDataType<Integer> {

  public PersistentInt(final String namespace, final String key) {
   ...
   */
  @Override
  public Integer decode(final String encoded) throws IllegalArgumentException {
