 ...
 * @see <a href="https://minecraft.wiki/w/Data_component_format#swing_animation">Reference</a>
...
public abstract class SwingAnimationComponent<I extends AbstractItemStack<T>, T> implements SerialComponent<I, T> {
  ...
  public SwingAnimationComponent(final String animation) {
  ...
  public boolean similar(final SerialComponent<?, ?> component) {
    ...
    if(!(component instanceof final SwingAnimationComponent<?, ?> other)) return false;
    return Objects.equals(this.animation, other.animation);
  }
