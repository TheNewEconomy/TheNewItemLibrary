...
/**
 * SignTextFrontComponent
 *
 * @see <a href="https://minecraft.wiki/w/Data_component_format#sign_text_front">Reference</a>
 * @author creatorfromhell
 * @since 0.2.0.0
 */
public abstract class SignTextFrontComponent<I extends AbstractItemStack<T>, T> implements SerialComponent<I, T> {

    protected final Component[] lines = new Component[4];
    protected int rgb;
    protected boolean glowing = false;

    public SignTextFrontComponent() {

    }

    public SignTextFrontComponent(final int rgb, final boolean glowing) {
    ...
    public boolean similar(final SerialComponent<?, ?> component) {
        ...
        if(!(component instanceof final SignTextFrontComponent<?, ?> other)) return false;
