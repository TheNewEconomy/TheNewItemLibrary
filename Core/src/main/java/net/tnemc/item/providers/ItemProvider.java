...
/**
 * An ItemProvider represents a provider used to give the Locale stack, and provide various item
 * stack comparisons. This could be used for something such as ItemsAdder, etc.
 *
...
public interface ItemProvider<T> extends Identifiable {
   ...
   * modelData - flags - lore - attributes - enchantments What this does not include: - Item
   * Data/components.
   *
