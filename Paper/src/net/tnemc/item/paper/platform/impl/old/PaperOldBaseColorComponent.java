 ...
 * @since 0.2.0.0
 */
public class PaperOldBaseColorComponent extends BaseColorComponent<PaperItemStack, ItemStack> {
  ...
  public ItemStack apply(final PaperItemStack serialized, final ItemStack item) {
    ...
    final Optional<PaperOldBaseColorComponent> componentOptional = serialized.component(identifier());
