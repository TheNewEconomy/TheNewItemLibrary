 ...
 * @since 0.2.0.0
 */
public class PaperOldChargedProjectilesComponent extends ContainerComponent<PaperItemStack, ItemStack> {
  ...
  public ItemStack apply(final PaperItemStack serialized, final ItemStack item) {
    ...
    final Optional<PaperOldChargedProjectilesComponent> componentOptional = serialized.component(identifier());
