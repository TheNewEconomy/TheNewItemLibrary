...
import net.tnemc.item.paper.component.PaperEquipComponent;
 ...
 * @since 0.1.7.7
 */
public class PaperItemEquip extends ItemEquip<PaperItemStack, ItemStack> {
  ...
  public PaperItemStack serialize(final ItemStack item, final PaperItemStack serialized) {
    ...
    if(meta != null && meta.hasEquippable()) {
      serialized.components().put("equip", PaperEquipComponent.create(item));
    }
    return serialized;
  }
}