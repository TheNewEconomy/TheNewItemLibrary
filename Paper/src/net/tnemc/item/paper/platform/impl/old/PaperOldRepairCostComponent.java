 ...
 * @since 0.2.0.0
 */
public class PaperOldRepairCostComponent extends RepairCostComponent<PaperItemStack, ItemStack> {
  ...
  public ItemStack apply(final PaperItemStack serialized, final ItemStack item) {
    ...
    final Optional<PaperOldRepairCostComponent> componentOptional = serialized.component(identifier());
