 ...
 * @since 0.2.0.0
 */
public class PaperOldGliderComponent extends GliderComponent<PaperItemStack, ItemStack> {
  ...
  public ItemStack apply(final PaperItemStack serialized, final ItemStack item) {
    ...
    final Optional<PaperOldGliderComponent> componentOptional = serialized.component(identifier());
