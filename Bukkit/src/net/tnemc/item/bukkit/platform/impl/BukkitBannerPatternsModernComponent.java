 ...
 * @since 0.2.0.0
 */
public class BukkitBannerPatternsModernComponent extends BannerPatternsComponent<BukkitItemStack, ItemStack> {
  ...
  public ItemStack apply(final BukkitItemStack serialized, final ItemStack item) {
    ...
    final Optional<BukkitBannerPatternsModernComponent> componentOptional = serialized.component(identifier());
      ...
      for(final Pattern pattern : meta.getPatterns()) {
        ...
        try {
          patterns.add(new PatternData(String.valueOf(pattern.getColor().getColor().asRGB()),
                                       pattern.getPattern().getKeyOrThrow().toString()));
