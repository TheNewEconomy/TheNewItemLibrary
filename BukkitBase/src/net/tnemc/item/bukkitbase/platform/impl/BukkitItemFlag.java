 ...
 * @since 0.1.7.7
 */
public class BukkitItemFlag<I extends AbstractItemStack<ItemStack>> extends net.tnemc.item.platform.impl.ItemFlag<I, ItemStack> {
  ...
  public I serialize(final ItemStack item, final I serialized) {
    ...
    final ItemMeta meta = item.getItemMeta();
    if(meta != null) {
      for(final ItemFlag flag : item.getItemMeta().getItemFlags()) {
