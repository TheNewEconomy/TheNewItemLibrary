 ...
 * @since 0.1.7.7
 */
public class BukkitItemGlider<I extends AbstractItemStack<ItemStack>> extends ItemGlider<I, ItemStack> {
  ...
  public ItemStack apply(final I serialized, final ItemStack item) {
    ...
    if(meta != null) {
      ...
      meta.setGlider(serialized.glider());
  ...
  public I serialize(final ItemStack item, final I serialized) {
    ...
    final ItemMeta meta = item.getItemMeta();
    if(meta != null) {
      serialized.glider(meta.isGlider());
    }
    return serialized;
  }
}